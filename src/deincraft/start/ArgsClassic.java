    ...
    public static String getStartArgs(String Username, int RAM) throws IOException {
        ...
        if (operatingSystem.equals(OperatingSystem.OSX)) {
          String[] Startargs = {
                ...
                "--icon \"" + DCpath() + "assets/packs/vanilla/icon.png\""
            };
            for (int i = 0; i <= 23 ;i++) {
